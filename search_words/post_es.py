...
import smtplib, xlwt, logging, traceback, datetime, openpyxl
import smtplib
...
def send_email_tome():
    try:
        ...
        textApart = MIMEText(content, _charset="utf-8")
...
def get_es_syno_word(word):
    ...
    res = es.indices.analyze(index='gm_test-answer', body=body)
...
if __name__ == "__main__":
    ...
    for name in list(data):
        ...
        print(complete_matching_term_set)
        ...
        tag_names_list.append(
            [word, sorteds, uv, diary_content_num, answer_content_num, tractate_content_num, sy_diary_content_num,
             sy_answer_content_num, sy_tractate_content_num])
