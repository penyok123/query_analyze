...
class Analyze:
    ...
    def cnt_mysql_mimas(self):
        ...
        db_mimas_eagle = pymysql.connect(host="bj-cdb-6slgqwlc.sql.tencentcdb.com", port=62120, user="work",
                                         password="Gengmei1",
                                         db="mimas_test",
                                         cursorclass=pymysql.cursors.DictCursor, charset='utf8')
    ...
    def cnt_mysql_jerry(self):
        db_jerry_eagle = pymysql.connect(host="bj-cdb-6slgqwlc.sql.tencentcdb.com", port=62120, user="work",
                                         password="Gengmei1",
                                         db="jerry_test",
                                         cursorclass=pymysql.cursors.DictCursor, charset='utf8')
